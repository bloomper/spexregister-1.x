...
public class CustomXmlDataSource implements JRDataSource {
     ...
     * @throws JRException
     */
    public CustomXmlDataSource(Document document, String selectExpression) throws JRException {
     ...
     * @throws JRException
     */
    public CustomXmlDataSource(String uri, String selectExpression) throws JRException {
        this(CustomXmlDataSource.loadDocumentFromFile(uri), selectExpression);
    }
     ...
     * @throws JRException
     */
    public CustomXmlDataSource(InputStream in) throws JRException {
        this(in, ".");
    }
     ...
     * @throws JRException
     */
    public CustomXmlDataSource(InputStream in, String selectExpression)
            throws JRException {
     ...
     * @throws JRException
     */
    public CustomXmlDataSource subDataSource(String selectExpr) throws JRException {
        Document doc = subDocument();
        return new CustomXmlDataSource(doc, selectExpr);
    }
     ...
     * @throws JRException
     */
    public CustomXmlDataSource dataSource(String selectExpr) throws JRException {
        return new CustomXmlDataSource(document, selectExpr);
    }
}
