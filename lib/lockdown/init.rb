...
set_permission(:spexare_management).with_controller(:spexare).and_controller(:pictures).and_controller(:cohabitants).and_controller(:memberships).and_controller(:activities).and_controller(:spex_activities).and_controller(:function_activities).and_controller(:actors).and_controller(:users).except_methods(:show, :index)
...
set_permission(:spexare_view).with_controller(:spexare).and_controller(:pictures).and_controller(:cohabitants).and_controller(:memberships).and_controller(:activities).and_controller(:spex_activities).and_controller(:function_activities).and_controller(:actors).only_methods(:show, :index)
