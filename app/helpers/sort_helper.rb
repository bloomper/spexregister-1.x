...
# Author:  Jonathan Conway, modified to allow sorting of associations, Feb 2006
...
module SortHelper
  ...
  #
  def sort_link(column, caption = nil, association = nil, url_options = {})
    ...
    link_to(caption + (icon ? nbsp(1) + image_tag(icon) : ''), params)
    #caption + link_to((icon ? nbsp(1) + image_tag(icon) : ''), params)
  end
  ...
  #   </th>
  #
  def sort_header_tag(column, options = {}, url_options = {})
    association = nil    
    ...
    content_tag('th', sort_link(column, caption, association, url_options), options)
  end
