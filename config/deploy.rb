...
set :repository, Proc.new { "--username #{scm_user} --password #{scm_password} --no-auth-cache svn://192.168.4.110:3690/spexregister/spexregister.ror/branches/1.0-maintenance"} 
